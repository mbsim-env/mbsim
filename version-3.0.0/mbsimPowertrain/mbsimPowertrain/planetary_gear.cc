...
//  gear = new Gear("Gear2");
//  addLink(gear);
//  //gear->setRatio(R3/R2b);
//  //gear->connect(shaft2,shaft3);
//  gear->setDependentBody(shaft3);
//  gear->addDependency(shaft2,-R2b/R3);
  //gear->setForceFunction(new LinearSpringDamperForce(1,0.1,0));
