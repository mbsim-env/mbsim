...
namespace MBSim {
  ...
  class ContactKinematicsCompoundContourCompoundContour : public ContactKinematics {
    public:
      ...
      virtual void updateg(fmatvec::Vec &g, ContourPointData *cpData) { throw MBSimError("ERROR (ContactKinematicsCompoundContourCompoundContour::updateg): Not implemented!"); }
