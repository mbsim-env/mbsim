...
namespace MBSim {
  ...
  void FiniteElement2s13MFRMindlin::computeR_ij(const fmatvec::Vec &NodeCoordinates) {
    ...
    R_ij(1,0) = rho * (0.10e2 * pow(cos(phi1), 0.2e1) * d2 * pow(r2, 0.6e1) - 0.10e2 * pow(cos(phi1), 0.2e1) * d2 * pow(r1, 0.6e1) - 0.10e2 * pow(cos(phi2), 0.2e1) * d2 * pow(r2, 0.6e1) + 0.10e2 * pow(cos(phi2), 0.2e1) * d2 * pow(r1, 0.6e1) + 0.12e2 * pow(cos(phi1), 0.2e1) * d1 * pow(r2, 0.5e1) - 0.12e2 * pow(cos(phi1), 0.2e1) * d1 * pow(r1, 0.5e1) - 0.12e2 * pow(cos(phi2), 0.2e1) * d1 * pow(r2, 0.5e1) + 0.12e2 * pow(cos(phi2), 0.2e1) * d1 * pow(r1, 0.5e1) + 0.15e2 * pow(cos(phi1), 0.2e1) * d0 * pow(r2, 0.4e1) - 0.15e2 * pow(cos(phi1), 0.2e1) * d0 * pow(r1, 0.4e1) - 0.15e2 * pow(cos(phi2), 0.2e1) * d0 * pow(r2, 0.4e1) + 0.15e2 * pow(cos(phi2), 0.2e1) * d0 * pow(r1, 0.4e1)) / 0.120e3;
