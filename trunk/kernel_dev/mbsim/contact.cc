...
namespace MBSim {
  ...
  void Contact::initializeUsingXML(TiXmlElement *element) {
    ...
    GeneralizedForceLaw *gfl=ObjectFactory::createGeneralizedForceLaw(e);
    setContactForceLaw(gfl);
    gfl->initializeUsingXML(e);
    e=e->NextSiblingElement();
    GeneralizedImpactLaw *gifl=ObjectFactory::createGeneralizedImpactLaw(e);
    setContactImpactLaw(gifl);
    gifl->initializeUsingXML(e);
    e=e->NextSiblingElement();
    FrictionForceLaw *ffl=ObjectFactory::createFrictionForceLaw(e);
    setFrictionForceLaw(ffl);
    ffl->initializeUsingXML(e);
    e=e->NextSiblingElement();
    FrictionImpactLaw *fil=ObjectFactory::createFrictionImpactLaw(e);
    setFrictionImpactLaw(fil);
    fil->initializeUsingXML(e);
