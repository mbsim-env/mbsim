...
namespace MBSim {
  ...
  class ContactKinematicsPointFrustum : public ContactKinematics {     
    public:
      ...
      virtual void updatewb(fmatvec::Vec &wb, const fmatvec::Vec &g, ContourPointData *cpData) { throw new MBSimError("ERROR(ContactKinematicsPointFrustum:updatewb): Not implemented!"); }
      /***************************************************/
