...
#ifndef _MBSIM_ACTUATOR_H_
#define _MBSIM_ACTUATOR_H_
...
namespace MBSim {
  ...
  /**
   * \brief actuator with time dependent force and moment functions
   * \author Martin Förg
   */
  class Actuator : public LinkMechanics {
    public:
       ...
       * This force vector is given in frame 1.
       */
      ...
      virtual std::string getType() const { return "Actuator"; }
