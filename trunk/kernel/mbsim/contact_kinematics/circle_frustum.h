...
namespace MBSim {
  ...
  class ContactKinematicsCircleFrustum : public ContactKinematics {
    public:
      ...
      virtual void updatewb(fmatvec::Vec& wb, const fmatvec::Vec &g,ContourPointData *cpData) { throw MBSimError("(ContactKinematicsCircleFrustum::updatewb): not implemented!"); }
      /***************************************************/
