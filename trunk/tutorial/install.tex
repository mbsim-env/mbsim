...
\begin{itemize}
	...
	\begin{itemize}
		\item[] \begin{verbatim}./configure --prefix=MBSim/Install
				CFLAGS="-g3 -O0 -pg" CXXFLAGS="-g3 -O0 -pg"
				F77FLAGS="-g3 -O0 -pg" FFLAGS="-g3 -O0 -pg"
				LDFLAGS="-pg" \end{verbatim}
