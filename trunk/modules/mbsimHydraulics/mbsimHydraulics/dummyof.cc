 ...
 */
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, SerialResistanceLinePressureLoss,  MBSIMHYDRAULICSNS"SerialResistanceLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, ParallelResistanceLinePressureLoss,  MBSIMHYDRAULICSNS"ParallelResistanceLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, ZetaLinePressureLoss,  MBSIMHYDRAULICSNS"ZetaLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, ZetaPosNegLinePressureLoss,  MBSIMHYDRAULICSNS"ZetaPosNegLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, LaminarTubeFlowLinePressureLoss,  MBSIMHYDRAULICSNS"LaminarTubeFlowLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, TurbulentTubeFlowLinePressureLoss,  MBSIMHYDRAULICSNS"TurbulentTubeFlowLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, CurveFittedLinePressureLoss,  MBSIMHYDRAULICSNS"CurveFittedLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, TabularLinePressureLoss,  MBSIMHYDRAULICSNS"TabularLinePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, RelativeAreaZetaClosablePressureLoss,  MBSIMHYDRAULICSNS"RelativeAreaZetaClosablePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, GapHeightClosablePressureLoss,  MBSIMHYDRAULICSNS"GapHeightClosablePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, ReynoldsClosablePressureLoss,  MBSIMHYDRAULICSNS"ReynoldsClosablePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, RelativeAlphaClosablePressureLoss,  MBSIMHYDRAULICSNS"RelativeAlphaClosablePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, GammaCheckvalveClosablePressureLoss,  MBSIMHYDRAULICSNS"GammaCheckvalveClosablePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, IdelchickCheckvalveClosablePressureLoss,  MBSIMHYDRAULICSNS"IdelchickCheckvalveClosablePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, ConeCheckvalveClosablePressureLoss,  MBSIMHYDRAULICSNS"ConeCheckvalveClosablePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, PlaneLeakagePressureLoss,  MBSIMHYDRAULICSNS"PlaneLeakagePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, EccentricCircularLeakagePressureLoss,  MBSIMHYDRAULICSNS"EccentricCircularLeakagePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, RealCircularLeakagePressureLoss,  MBSIMHYDRAULICSNS"RealCircularLeakagePressureLoss")
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORY(Function, UnidirectionalZetaPressureLoss,  MBSIMHYDRAULICSNS"UnidirectionalZetaPressureLoss")
...
MBSIM_REGISTER_XMLNAME_AT_OBJECTFACTORYASSINGLETON(Environment, HydraulicEnvironment, MBSIMHYDRAULICSNS"HydraulicEnvironment")
