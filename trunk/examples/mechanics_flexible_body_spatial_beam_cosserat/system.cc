...
System::System(const string &projectName) : DynamicSystemSolver(projectName) {
  ...
  OpenMBV::PolygonPoint *corner1 = new OpenMBV::PolygonPoint(b0*0.1,b0*0.1,1);
  rectangle->push_back(corner1);
  OpenMBV::PolygonPoint *corner2 = new OpenMBV::PolygonPoint(b0*0.1,-b0*0.1,1);
  rectangle->push_back(corner2);
  OpenMBV::PolygonPoint *corner3 = new OpenMBV::PolygonPoint(-b0*0.1,-b0*0.1,1);
  rectangle->push_back(corner3);
  OpenMBV::PolygonPoint *corner4 = new OpenMBV::PolygonPoint(-b0*0.1,b0*0.1,1);
  ...
  double R = (l0/(2.*M_PI))*1.1; // stretched circle
