...
namespace MBSimFlexibleBody {
  FiniteElement1s33RCM::FiniteElement1s33RCM(double l0_, double rho_, double A_, double E_, double G_, double I1_, double I2_, double I0_, const fmatvec::Vec& g_, RevCardanPtr ag_) :
  ...
  void FiniteElement1s33RCM::computeM(const fmatvec::Vec16& qG) {
  ...
  void FiniteElement1s33RCM::computeh(const fmatvec::Vec16& qG, const fmatvec::Vec16& qGt) {
  ...
  void FiniteElement1s33RCM::computedhdz(const fmatvec::Vec16& qG, const fmatvec::Vec16& qGt) {
    fmatvec::Vec16 h0 = h;
