...
namespace MBSimControl {
  ...
  class AbsolutCoordinateSensor : public Sensor {
    public:
      AbsolutCoordinateSensor(const std::string &name) : Sensor(name), frame(NULL), direction(0,0, fmatvec::INIT), frameString("") {}
  ...
  class RelativeCoordinateSensor : public Sensor {
    public:
      RelativeCoordinateSensor(const std::string &name) : Sensor(name), refFrame(NULL), relFrame(NULL), direction(0,0, fmatvec::INIT), refFrameString(""), relFrameString("") {}
