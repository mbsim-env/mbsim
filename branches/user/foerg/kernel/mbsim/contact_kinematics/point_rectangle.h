...
namespace MBSim {
  ...
  class ContactKinematicsPointRectangle : public ContactKinematics {
    public:
      ...
      virtual void updatewb(fmatvec::Vec &wb, const fmatvec::Vec &g, ContourPointData* cpData) { throw MBSimError("(ContactKinematicsPointRectangle::updatewb): Not implemented!"); };
      /***************************************************/
