...
//  connections = new ExtWidget("Connections",new ConnectFramesWidget(1,this));
  properties->addToTab("Kinetics",connections);

  ForceChoiceWidget *f = new ForceChoiceWidget(forceArrow);
  force = new ExtWidget("Force",f,true);
  properties->addToTab("Kinetics",force);

  ForceChoiceWidget *m = new ForceChoiceWidget(momentArrow);
