...
namespace MBSim {
  ...
  class FuncPairConeSectionCircle : public DistanceFunction<double,double> {
    public:
      ...
      virtual fmatvec::FVec computeWrD(const double &phi) = 0;
      /*************************************************/

      /* GETTER / SETTER */
      void setDiffVec(fmatvec::FVec d_);

      void setSectionCOS(fmatvec::FVec b1_,fmatvec::FVec b2_);
      /*************************************************/
  ...
  inline void FuncPairConeSectionCircle::setDiffVec(fmatvec::FVec d_) { d=d_; }
  inline void FuncPairConeSectionCircle::setSectionCOS(fmatvec::FVec b1_,fmatvec::FVec b2_) { b1=b1_; b2=b2_; }
  ...
  class FuncPairEllipseCircle : public FuncPairConeSectionCircle {
    public:
      ...
      fmatvec::FVec computeWrD(const double &phi);
      /*************************************************/

      /* GETTER / SETTER */
      void setEllipseCOS(fmatvec::FVec b1e_,fmatvec::FVec b2e_);
      /*************************************************/
  };

  inline void FuncPairEllipseCircle::setEllipseCOS(fmatvec::FVec b1e_,fmatvec::FVec b2e_) {setSectionCOS(b1e_,b2e_);}
  ...
  inline fmatvec::FVec FuncPairEllipseCircle::computeWrD(const double &phi) { return d + b1*a*cos(phi) + b2*b*sin(phi); }
  ...
  inline fmatvec::FVec FuncPairHyperbolaCircle::computeWrD(const double &phi) { return d + b1*a*cosh(phi) + b2*b*sinh(phi); }
  ...
  inline void JacobianPairConeSectionCircle::setDiffVec(fmatvec::FVec d_) { d=d_; }
  inline void JacobianPairConeSectionCircle::setSectionCOS(fmatvec::FVec b1_,fmatvec::FVec b2_) { b1=b1_; b2=b2_; }
  ...
  class FuncPairContour1sLine : public DistanceFunction<double,double> {
    public:
      ...
      virtual fmatvec::FVec computeWrD(const double &s) {
  ...
  class FuncPairContour1sCircleSolid : public DistanceFunction<double,double> {
    public:
      ...
      double operator()(const double &alpha, const void * =NULL) {
        ...
        fmatvec::FVec Wd = computeWrD(alpha);
        fmatvec::FVec Wt = contour->computeTangent(cp);
        return Wt.T()*Wd;
      }
