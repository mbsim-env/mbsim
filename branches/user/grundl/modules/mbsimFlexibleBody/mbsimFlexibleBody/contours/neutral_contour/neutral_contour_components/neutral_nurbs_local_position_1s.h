...
namespace MBSimFlexibleBody {
  ...
  class NeutralNurbsLocalPosition1s : public MBSimFlexibleBody::NeutralNurbs1s {
    public:
      NeutralNurbsLocalPosition1s(Element* parent_, std::vector<ContourPointData>& ContourPoints_, double nodeOffset_, double uMin_, double uMax_, int degU_, bool openStructure_);
