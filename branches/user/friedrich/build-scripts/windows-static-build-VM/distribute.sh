...
DISTDIR1=/c/tmp/mbsimdist
DISTDIR=$DISTDIR1/mbsimxml
LOCALDIR=/c/project/local
...
Unpack mbsimxml-windows-static.zip to a directory of your choice.
# cd <myinstdir>
# unzip <downloaddir>/mbsimxml-windows-static.zip
...
# generate tar.bz2
cd $DISTDIR1
rm /c/project/mbsimxml-windows-static.zip
zip -r /c/project/mbsimxml-windows-static.zip mbsimxml mbsimxmlexamples
