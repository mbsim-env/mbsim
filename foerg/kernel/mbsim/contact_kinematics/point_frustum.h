...
namespace MBSim {
  ...
  class ContactKinematicsPointFrustum : public ContactKinematics {
    public:
      ...
      virtual void updatewb(fmatvec::Vec &wb, const fmatvec::Vec &g, ContourPointData *cpData) { throw MBSimError("(ContactKinematicsPointFrustum:updatewb): Not implemented!"); }
      /***************************************************/
