...
namespace MBSim {
  ...
  void ThetaTimeSteppingSSCIntegrator::update(DynamicSystemSolver& system, const Vec& z, double t) {
  ...
  void ThetaTimeSteppingSSCIntegrator::subIntegrate(DynamicSystemSolver& system, double tStop) {
  ...
  void ThetaTimeSteppingSSCIntegrator::postIntegrate(DynamicSystemSolver& system) {
    integPlot.close();
  ...
  void ThetaTimeSteppingSSCIntegrator::initializeUsingXML(TiXmlElement *element) {
