...
Contour::Contour(const QString &str, QTreeWidgetItem *parentItem, int ind) : Element(str,parentItem,ind) {
  //refFrame = new ExtWidget("Frame of reference",new FrameOfReferenceWidget(MBSIMNS"frameOfReference",this,getParentElement()->getFrame(0)));
  refFrame = new ExtWidget("Frame of reference",new ParentFrameOfReferenceWidget(this,0),true);
