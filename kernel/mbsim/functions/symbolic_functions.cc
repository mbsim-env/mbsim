...
namespace MBSim {
  ...
  //MBSIM_OBJECTFACTORY_REGISTERXMLNAME_AND_INSTANTIATE(SymbolicFunction<Vec(VecV)>, MBSIM%"SymbolicFunction")
  //MBSIM_OBJECTFACTORY_REGISTERXMLNAME_AND_INSTANTIATE(SymbolicFunction<Vec(Vec3)>, MBSIM%"SymbolicFunction")
  //MBSIM_OBJECTFACTORY_REGISTERXMLNAME_AND_INSTANTIATE(SymbolicFunction<VecV(Vec)>, MBSIM%"SymbolicFunction")
  ...
  //MBSIM_OBJECTFACTORY_REGISTERXMLNAME_AND_INSTANTIATE(SymbolicFunction<Vec3(Vec)>, MBSIM%"SymbolicFunction")
  ...
  //MBSIM_OBJECTFACTORY_REGISTERXMLNAME_AND_INSTANTIATE(SymbolicFunction<Vec(VecV,double)>, MBSIM%"SymbolicFunction")
  //MBSIM_OBJECTFACTORY_REGISTERXMLNAME_AND_INSTANTIATE(SymbolicFunction<Vec(Vec3,double)>, MBSIM%"SymbolicFunction")
  //MBSIM_OBJECTFACTORY_REGISTERXMLNAME_AND_INSTANTIATE(SymbolicFunction<VecV(Vec,double)>, MBSIM%"SymbolicFunction")
