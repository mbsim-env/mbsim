...
namespace MBSim {
  ...
  fmatvec::Vec2 InfluenceFunction::evalZeta(const std::pair<Contour*, ContourFrame*>& contourInfo) {
    return contourInfo.first->evalZeta(contourInfo.second->evalPosition());
  }
