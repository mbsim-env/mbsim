...
namespace MBSim {
  ...
  class GeneralizedVelocityConstraint : public GeneralizedKinematicConstraint {

    public:
      GeneralizedVelocityConstraint(const std::string &name="") : GeneralizedKinematicConstraint(name), f(NULL) { }
