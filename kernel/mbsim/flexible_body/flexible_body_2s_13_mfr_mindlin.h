...
namespace MBSim {
  ...
  inline void FlexibleBody2s13MFRMindlin::GlobalMatrixContribution(int CurrentElement, const fmatvec::Mat& locMat, fmatvec::Mat& gloMat) { throw new MBSimError("ERROR(FlexibleBody2s13MFRMindlin::GlobalMatrixContribution): Not implemented!"); }
  inline void FlexibleBody2s13MFRMindlin::GlobalMatrixContribution(int CurrentElement, const fmatvec::SymMat& locMat, fmatvec::SymMat& gloMat) { throw new MBSimError("ERROR(FlexibleBody2s13MFRMindlin::GlobalMatrixContribution): Not implemented!"); }
