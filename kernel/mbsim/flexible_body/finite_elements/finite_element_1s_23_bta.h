...
namespace MBSim {
  ...
  class FiniteElement1s23BTA : public DiscretizationInterface {
    public:
      ...
      /* GETTER / SETTER */
      void setMaterialDamping(double) { throw new MBSimError("ERROR (FiniteElement1s23BTA:setMaterialDamping): Not implemented!"); }
      void setLehrDamping(double) { throw new MBSimError("ERROR (FiniteElement1s23BTA:setLehrDamping): Not implemented!"); }
  ...
  inline double FiniteElement1s23BTA::computeKineticEnergy(const fmatvec::Vec& q,const fmatvec::Vec& u) { throw new MBSimError("ERROR (FiniteElement1s23BTA:computeKineticEnergy): Not implemented!"); }
  inline double FiniteElement1s23BTA::computeGravitationalEnergy(const fmatvec::Vec& q) { throw new MBSimError("ERROR WARNING (FiniteElement1s23BTA:computeGravitationalEnergy): Not implemented!"); }     
  inline double FiniteElement1s23BTA::computeElasticEnergy(const fmatvec::Vec& q) { throw new MBSimError("ERROR (FiniteElement1s23BTA:computeElasticEnergy): Not implemented!"); }
  inline fmatvec::Vec FiniteElement1s23BTA::computePosition(const fmatvec::Vec& q, const ContourPointData &data) { throw new MBSimError("ERROR (FiniteElement1s23BTA::computePosition): Not implemented!"); }
  inline fmatvec::SqrMat FiniteElement1s23BTA::computeOrientation(const fmatvec::Vec& q, const ContourPointData &data) { throw new MBSimError("ERROR (FiniteElement1s23BTA::computeOrientation): Not implemented!"); }
  inline fmatvec::Vec FiniteElement1s23BTA::computeVelocity(const fmatvec::Vec& q, const fmatvec::Vec& u, const ContourPointData &data) { throw new MBSimError("ERROR (FiniteElement1s23BTA::computeVelocity): Not implemented!");}
  inline fmatvec::Vec FiniteElement1s23BTA::computeAngularVelocity(const fmatvec::Vec& q, const fmatvec::Vec& u, const ContourPointData &data) { throw new MBSimError("ERROR (FiniteElement1s23BTA::computeAngularVelocity): Not implemented!"); }
  inline fmatvec::Mat FiniteElement1s23BTA::computeJacobianOfMotion(const fmatvec::Vec& q,const ContourPointData &data) { return JGeneralized(q,data.getLagrangeParameterPosition()(0)); }
