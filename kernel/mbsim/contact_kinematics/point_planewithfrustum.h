...
namespace MBSim {
  ...
  class ContactKinematicsPointPlaneWithFrustum : public ContactKinematics {
    public:
      ...
      virtual void updatewb(fmatvec::Vec &wb, double g, std::vector<ContourFrame*> &cFrame) { throw MBSimError("(ContactKinematicsPointPlaneWithFrustum::updatewb): Not implemented!"); };
      /***************************************************/
