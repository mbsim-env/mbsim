...
namespace MBSim {
  ...
  class ContactKinematicsPointPlaneWithFrustum : public ContactKinematics {
    public:
      ...
      void updatewb(fmatvec::Vec &wb, double g, std::vector<ContourFrame*> &cFrame) override { throw MBSimError("(ContactKinematicsPointPlaneWithFrustum::updatewb): Not implemented!"); };
      /***************************************************/
