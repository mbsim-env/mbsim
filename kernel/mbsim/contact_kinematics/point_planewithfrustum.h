...
namespace MBSim {
  ...
  class ContactKinematicsPointPlaneWithFrustum : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, std::vector<ContourFrame*> &cFrame) { throw MBSimError("(ContactKinematicsPointPlaneWithFrustum::updatewb): Not implemented!"); };
      /***************************************************/
