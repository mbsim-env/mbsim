...
namespace MBSim {
  ...
  class ContactKinematicsCompoundContourContour : public ContactKinematics {
    public:
      ...
      virtual void updateg(fmatvec::Vec &g, ContourPointData *cpData) { throw MBSimError("ERROR (ContactKinematicsCompoundContourContour::updateg): Not implemented!"); }
      virtual void updatewb(fmatvec::Vec &wb, const fmatvec::Vec &g, ContourPointData* cpData) { throw MBSimError("ERROR (ContactKinematicsCompoundContourContour::updatewb): Not implemented!"); };
