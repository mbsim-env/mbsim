...
namespace MBSim {
  ...
  class ContactKinematicsCirclePlane : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, std::vector<ContourFrame*> &cFrame) { throw MBSimError("(ContactKinematicsCirclePlane::updatewb): Not implemented!"); };
      /***************************************************/
