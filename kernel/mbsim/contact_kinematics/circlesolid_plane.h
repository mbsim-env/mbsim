...
namespace MBSim {
  ...
  class ContactKinematicsCircleSolidPlane : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, ContourPointData* cpData) { throw MBSimError("(ContactKinematicsCircleSolidPlane::updatewb): Not implemented!"); };
      /***************************************************/
