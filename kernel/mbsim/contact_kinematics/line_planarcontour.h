...
namespace MBSim {
  ...
  class ContactKinematicsLinePlanarContour : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, std::vector<ContourFrame*> &cFrame) { throw MBSimError("(ContactKinematicsLinePlanarContour::updatewb): Not implemented!"); };
      /***************************************************/
