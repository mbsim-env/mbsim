...
namespace MBSim {
  ...
  class ContactKinematicsPointContourInterpolation : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, ContourPointData* cpData) { throw MBSimError("(ContactKinematicsPointContourInterpolation::updatewb): Not implemented!"); };
      /***************************************************/
