...
namespace MBSim {
  ...
  class ContactKinematicsPointContourInterpolation : public ContactKinematics {
    public:
      ...
      virtual void updatewb(fmatvec::Vec &wb, const fmatvec::Vec &g, ContourPointData* cpData) { throw MBSimError("ERROR (ContactKinematicsPointContourInterpolation::updatewb): Not implemented!"); };
      /***************************************************/
