...
namespace MBSim {
  ...
  class ContactKinematicsSphereSphere : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, ContourPointData *cpData) { throw MBSimError("(ContactKinematicsSphereSphere:updatewb): Not implemented!"); }
