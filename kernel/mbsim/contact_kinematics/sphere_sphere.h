...
namespace MBSim {
  ...
  class ContactKinematicsSphereSphere : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, std::vector<ContourFrame*> &cFrame) { throw MBSimError("(ContactKinematicsSphereSphere:updatewb): Not implemented!"); }
