...
namespace MBSim {
  ...
  class ContactKinematicsPointFrustum : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, ContourPointData *cpData) { throw MBSimError("(ContactKinematicsPointFrustum:updatewb): Not implemented!"); }
      /***************************************************/
