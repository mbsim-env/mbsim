...
namespace MBSim {
  ...
  class ContactKinematicsPointPlate : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, std::vector<ContourFrame*> &cFrame) { throw MBSimError("(ContactKinematicsPointPlate::updatewb): Not implemented!"); };
      /***************************************************/
