...
namespace MBSim {
  ...
  class ContactKinematicsPointRectangle : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, ContourPointData* cpData) { throw MBSimError("(ContactKinematicsPointRectangle::updatewb): Not implemented!"); };
      /***************************************************/
