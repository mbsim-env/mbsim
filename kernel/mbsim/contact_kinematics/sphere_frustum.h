...
namespace MBSim {
  ...
  class ContactKinematicsSphereFrustum : public ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec &wb, double g, std::vector<Frame*> &cFrame) { throw MBSimError("(ContactKinematicsSphereFrustum:updatewb): Not implemented!"); }
      /***************************************************/
