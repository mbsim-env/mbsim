...
#ifndef _PLANAR_STRIBECK_IMPACT_H_
#define _PLANAR_STRIBECK_IMPACT_H_
...
namespace MBSim {
  ...
  class PlanarStribeckImpact : public FrictionImpactLaw {
    public:
       ...
       * \brief constructor
       */
      PlanarStribeckImpact(Function<double(double)> *fmu_=nullptr) : fmu(fmu_) {
       ...
       * \brief destructor
       */
      ~PlanarStribeckImpact() override { if(fmu) delete fmu; fmu=nullptr; }
