...
namespace MBSim {
  ...
  Mat FiniteElement1s21RCM::JpGeneralized(Vec& qElement, Vec& qpElement,const double& s, const double& sp) {
    ...
    SqrMat  Jeg(8,fmatvec::NONINIT);
    SqrMat Jegp(8,fmatvec::NONINIT);
    ...
    if(sp == 0 ) { // Ohne Relativbewegung auf der Kontour -----------------
      if( s < 0 ) { // Linker Teilbereich
	// zeitableitung, nur Translation
	//Jp(0,0) = 0;
	//Jp(0,1) = 0;
	//Jp(1,0) = 0;
	//Jp(1,1) = 0;
	Jp(2,0) = (s*(2*(1 + eps)*(bLp - phiSp)*cos(bL - phiS) + 4*epsp*(bLp - phiSp)*cos(bL - phiS) + (Power(bLp - phiSp,2)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + ((-(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + 2*epsp*sin(bL - phiS) - 2*(1 + eps)*Power(bLp - phiSp,2)*sin(bL - phiS) + ((bLp - phiSp)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4) - (2*(bLp - phiSp)*(-(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4)))/2.;
	Jp(2,1) = (s*(2*epsp*cos(bL - phiS) - 2*(1 + eps)*Power(bLp - phiSp,2)*cos(bL - phiS) + ((bLp - phiSp)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + (2*(bLp - phiSp)*(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) - 2*(1 + eps)*(bLp - phiSp)*sin(bL - phiS) - 4*epsp*(bLp - phiSp)*sin(bL - phiS) - (Power(bLp - phiSp,2)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4) + ((bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4)))/2.;
	Jp(3,0) = (bLp - phiSp)*s*((-bLp + phiSp)*cos(bL - phiS) - sin(bL - phiS));
	Jp(3,1) = (bLp - phiSp)*s*(-cos(bL - phiS) + (bLp - phiSp)*sin(bL - phiS));
	Jp(4,0) = (4*(bLp - phiSp)*Power(s,2)*(-Power(l0,2) + 4*l0*s + 8*Power(s,2))*(cos(bL - phiS) + (-bLp + phiSp)*sin(bL - phiS)))/Power(l0,4);
	Jp(4,1) = (4*(bLp - phiSp)*Power(s,2)*(Power(l0,2) - 4*l0*s - 8*Power(s,2))*((bLp - phiSp)*cos(bL - phiS) + sin(bL - phiS)))/Power(l0,4);
	Jp(5,0) = (s*(-2*(1 + eps)*(bLp - phiSp)*cos(bL - phiS) - 4*epsp*(bLp - phiSp)*cos(bL - phiS) + ((bLp - phiSp)*(2*l0 - 5*s)*Power(l0 + 2*s,2)*cos(bL - phiS))/Power(l0,3) - (Power(bLp - phiSp,2)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + ((bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) - 2*epsp*sin(bL - phiS) + 2*(1 + eps)*Power(bLp - phiSp,2)*sin(bL - phiS) - (Power(bLp - phiSp,2)*(2*l0 - 5*s)*Power(l0 + 2*s,2)*sin(bL - phiS))/Power(l0,3) - ((bLp - phiSp)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4) - (2*(bLp - phiSp)*(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4)))/2.;
	Jp(5,1) = (s*(-2*epsp*cos(bL - phiS) + 2*(1 + eps)*Power(bLp - phiSp,2)*cos(bL - phiS) - (Power(bLp - phiSp,2)*(2*l0 - 5*s)*Power(l0 + 2*s,2)*cos(bL - phiS))/Power(l0,3) + ((bLp - phiSp)*(-(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aR - 3*bR*l0)*Power(l0 + 2*s,2) + 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + (2*(bLp - phiSp)*(-(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + 2*(1 + eps)*(bLp - phiSp)*sin(bL - phiS) + 4*epsp*(bLp - phiSp)*sin(bL - phiS) - ((bLp - phiSp)*(2*l0 - 5*s)*Power(l0 + 2*s,2)*sin(bL - phiS))/Power(l0,3) + (Power(bLp - phiSp,2)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4) + ((-(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sin(bL - phiS))/Power(l0,4)))/2.;
	Jp(6,0) = (-4*(bLp - phiSp)*Power(s,2)*Power(l0 + 2*s,2)*(cos(bL - phiS) + (-bLp + phiSp)*sin(bL - phiS)))/Power(l0,4);
	Jp(6,1) = (4*(bLp - phiSp)*Power(s,2)*Power(l0 + 2*s,2)*((bLp - phiSp)*cos(bL - phiS) + sin(bL - phiS)))/Power(l0,4);
	Jp(7,0) = (3*(bLp - phiSp)*Power(s,2)*Power(l0 + 2*s,2)*(cos(bL - phiS) + (-bLp + phiSp)*sin(bL - phiS)))/(2.*Power(l0,3));
	Jp(7,1) = (-3*(bLp - phiSp)*Power(s,2)*Power(l0 + 2*s,2)*((bLp - phiSp)*cos(bL - phiS) + sin(bL - phiS)))/(2.*Power(l0,3));
	// Rotation
	// alle gleich Null !!!!!!!!!
      } else {
	// zeitableitung, nur Translation
	...
	//Jp(1,0) = 0;
	//Jp(1,1) = 0;
	Jp(2,0) = (s*(-2*(1 + eps)*(bRp + phiSp)*cos(bR + phiS) - 4*epsp*(bRp + phiSp)*cos(bR + phiS) - (Power(bRp + phiSp,2)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS))/Power(l0,4) + ((bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS))/Power(l0,4) - 2*epsp*sin(bR + phiS) + 2*(1 + eps)*Power(bRp + phiSp,2)*sin(bR + phiS) - ((bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS))/Power(l0,4) - (2*(bRp + phiSp)*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS))/Power(l0,4)))/2.;
	Jp(2,1) = (s*(2*epsp*cos(bR + phiS) - 2*(1 + eps)*Power(bRp + phiSp,2)*cos(bR + phiS) + ((bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS))/Power(l0,4) + (2*(bRp + phiSp)*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS))/Power(l0,4) - 2*(1 + eps)*(bRp + phiSp)*sin(bR + phiS) - 4*epsp*(bRp + phiSp)*sin(bR + phiS) - (Power(bRp + phiSp,2)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS))/Power(l0,4) + ((bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS))/Power(l0,4)))/2.;
	Jp(3,0) = (bRp + phiSp)*s*(-((bRp + phiSp)*cos(bR + phiS)) - sin(bR + phiS));
	Jp(3,1) = (bRp + phiSp)*s*(cos(bR + phiS) - (bRp + phiSp)*sin(bR + phiS));
	Jp(4,0) = (4*(bRp + phiSp)*Power(l0 - 2*s,2)*Power(s,2)*(cos(bR + phiS) - (bRp + phiSp)*sin(bR + phiS)))/Power(l0,4);
	Jp(4,1) = (4*(bRp + phiSp)*Power(l0 - 2*s,2)*Power(s,2)*((bRp + phiSp)*cos(bR + phiS) + sin(bR + phiS)))/Power(l0,4);
	Jp(5,0) = (3*(bRp + phiSp)*Power(l0 - 2*s,2)*Power(s,2)*(-cos(bR + phiS) + (bRp + phiSp)*sin(bR + phiS)))/(2.*Power(l0,3));
	Jp(5,1) = (-3*(bRp + phiSp)*Power(l0 - 2*s,2)*Power(s,2)*((bRp + phiSp)*cos(bR + phiS) + sin(bR + phiS)))/(2.*Power(l0,3));
	Jp(6,0) = (4*(bRp + phiSp)*Power(s,2)*(Power(l0,2) + 4*l0*s - 8*Power(s,2))*(cos(bR + phiS) - (bRp + phiSp)*sin(bR + phiS)))/Power(l0,4);
	Jp(6,1) = (4*(bRp + phiSp)*Power(s,2)*(Power(l0,2) + 4*l0*s - 8*Power(s,2))*((bRp + phiSp)*cos(bR + phiS) + sin(bR + phiS)))/Power(l0,4);
	Jp(7,0) = (s*(-4*epsp*Power(l0,4)*(bRp + phiSp)*cos(bR + phiS) - l0*(bRp + phiSp)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*cos(bR + phiS) - Power(bRp + phiSp,2)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS) + (bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS) - 2*epsp*Power(l0,4)*sin(bR + phiS) + l0*Power(bRp + phiSp,2)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*sin(bR + phiS) - (bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS) - 2*(bRp + phiSp)*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS)))/(2.*Power(l0,4));
	Jp(7,1) = (s*(2*epsp*Power(l0,4)*cos(bR + phiS) - l0*Power(bRp + phiSp,2)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*cos(bR + phiS) + (bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS) + 2*(bRp + phiSp)*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS) - 4*epsp*Power(l0,4)*(bRp + phiSp)*sin(bR + phiS) - l0*(bRp + phiSp)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*sin(bR + phiS) - Power(bRp + phiSp,2)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS) + (bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sin(bR + phiS)))/(2.*Power(l0,4));
	// Rotation
	// alle gleich Null !!!!!!!!!
      }
    } else { // Mit Relativbewegung auf der Kontour -----------------
      if( s < 0 ) {// Linker Teilbereich
	//JTLp
	Jp(0,0) = 0;
	Jp(0,1) = 0;
	Jp(1,0) = 0;
	Jp(1,1) = 0;
	Jp(2,0) = (2*(1 + eps)*(bLp - phiSp)*s*cos(bL - phiS) + 4*epsp*(bLp - phiSp)*s*cos(bL - phiS) + (Power(bLp - phiSp,2)*s*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + 4*(1 + eps)*(bLp - phiSp)*sp*cos(bL - phiS) + ((-(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aR - 3*bR*l0)*Power(l0 + 2*s,2) + 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sp*cos(bL - phiS))/Power(l0,4) + (2*sp*(-(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + ((l0 + 2*s)*(l0*(8*aR - 3*(bL + bR)*l0) + 6*(8*aR + 5*bL*l0 - 3*bR*l0)*s) + 8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)))*sp)*cos(bL - phiS))/Power(l0,4) + (s*(s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + (8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + 16*aLp*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + (l0 + 2*s)*(8*aR*(l0 + 6*s) + 16*aRp*(l0 + 6*s) - 3*l0*(bL*(l0 - 10*s) + (bR + 2*bRp)*(l0 + 6*s))))*sp + 8*(8*aR*(l0 + 3*s) - 8*aL*(l0 + 6*s) + 3*l0*(-(bR*(l0 + 3*s)) + bL*(l0 + 5*s)))*Power(sp,2) - bLp*l0*(l0 + 2*s)*(2*Power(l0,2) - l0*(s - 6*sp) - 10*s*(s + 6*sp)))*cos(bL - phiS))/Power(l0,4) + 2*(epsp*s - (1 + eps)*Power(bLp - phiSp,2)*s + ((bLp - phiSp)*s*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2)))))/(2.*Power(l0,4)) + (1 + eps)*sp + 2*epsp*sp + ((bLp - phiSp)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sp)/Power(l0,4) + ((-bLp + phiSp)*s*(-(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + ((l0 + 2*s)*(l0*(8*aR - 3*(bL + bR)*l0) + 6*(8*aR + 5*bL*l0 - 3*bR*l0)*s) + 8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)))*sp))/Power(l0,4))*sin(bL - phiS))/2.;
	Jp(2,1) = epsp*s*cos(bL - phiS) - (1 + eps)*Power(bLp - phiSp,2)*s*cos(bL - phiS) + ((bLp - phiSp)*s*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/(2.*Power(l0,4)) + (1 + eps)*sp*cos(bL - phiS) + 2*epsp*sp*cos(bL - phiS) + ((bLp - phiSp)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sp*cos(bL - phiS))/Power(l0,4) + ((bLp - phiSp)*s*(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + (-8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + (l0 + 2*s)*(-8*aR*(l0 + 6*s) + 3*l0*(bL*l0 + bR*l0 - 10*bL*s + 6*bR*s)))*sp)*cos(bL - phiS))/Power(l0,4) + ((-2*(1 + eps)*(bLp - phiSp)*s + 4*epsp*(-bLp + phiSp)*s + (Power(bLp - phiSp,2)*s*(-(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aR - 3*bR*l0)*Power(l0 + 2*s,2) + 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2)))))/Power(l0,4) - 4*(1 + eps)*(bLp - phiSp)*sp + ((bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sp)/Power(l0,4) + (2*sp*(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + (-8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + (l0 + 2*s)*(-8*aR*(l0 + 6*s) + 3*l0*(bL*l0 + bR*l0 - 10*bL*s + 6*bR*s)))*sp))/Power(l0,4) + (s*(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + ((l0 + 2*s)*(l0*(-8*(aR + 2*aRp) + 3*(bL + 2*bLp + bR + 2*bRp)*l0) - 6*(8*(aR + 2*aRp) + (5*bL + 10*bLp - 3*bR - 6*bRp)*l0)*s) - 8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) - 16*aLp*(Power(l0,2) - 8*l0*s - 24*Power(s,2)))*sp + 8*(-8*aR*(l0 + 3*s) + 8*aL*(l0 + 6*s) + 3*l0*(bR*(l0 + 3*s) - bL*(l0 + 5*s)))*Power(sp,2)))/Power(l0,4))*sin(bL - phiS))/2.;
	Jp(3,0) = (-(Power(bLp - phiSp,2)*s) + sp)*cos(bL - phiS) - (bLp - phiSp)*(s + 2*sp)*sin(bL - phiS);
	Jp(3,1) = -((bLp - phiSp)*(s + 2*sp)*cos(bL - phiS)) + (Power(bLp - phiSp,2)*s - sp)*sin(bL - phiS);
	Jp(4,0) = (4*((bLp - phiSp)*s*(-(Power(l0,2)*(s + 4*sp)) + 4*l0*s*(s + 6*sp) + 8*Power(s,2)*(s + 8*sp))*cos(bL - phiS) + (Power(bLp - phiSp,2)*Power(s,2)*(Power(l0,2) - 4*l0*s - 8*Power(s,2)) - 2*(l0 - 8*s)*s*(l0 + 2*s)*sp - 2*(Power(l0,2) - 12*l0*s - 48*Power(s,2))*Power(sp,2))*sin(bL - phiS)))/Power(l0,4);
	Jp(4,1) = (4*((Power(bLp - phiSp,2)*Power(s,2)*(Power(l0,2) - 4*l0*s - 8*Power(s,2)) - 2*(l0 - 8*s)*s*(l0 + 2*s)*sp - 2*(Power(l0,2) - 12*l0*s - 48*Power(s,2))*Power(sp,2))*cos(bL - phiS) + (bLp - phiSp)*s*(Power(l0,2)*(s + 4*sp) - 4*l0*s*(s + 6*sp) - 8*Power(s,2)*(s + 8*sp))*sin(bL - phiS)))/Power(l0,4);
	Jp(5,0) = (-2*(1 + eps)*(bLp - phiSp)*s*cos(bL - phiS) + 4*epsp*(-bLp + phiSp)*s*cos(bL - phiS) + ((bLp - phiSp)*(2*l0 - 5*s)*s*Power(l0 + 2*s,2)*cos(bL - phiS))/Power(l0,3) + (Power(bLp - phiSp,2)*s*(-(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aR - 3*bR*l0)*Power(l0 + 2*s,2) + 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) + (8*(bLp - phiSp)*(2*l0 - 5*s)*s*(l0 + 2*s)*sp*cos(bL - phiS))/Power(l0,3) - (10*(bLp - phiSp)*s*Power(l0 + 2*s,2)*sp*cos(bL - phiS))/Power(l0,3) + ((bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sp*cos(bL - phiS))/Power(l0,4) + (2*sp*(2*eps*Power(l0,4)*phiSp + s*(Power(l0,2)*(-8*aLp - 8*aRp + 3*bRp*l0 - 3*l0*phiSp) + 4*l0*(8*aLp - 8*aRp + 3*l0*(bRp + phiSp))*s + 4*(16*aLp - 8*aRp + 3*bRp*l0 + 5*l0*phiSp)*Power(s,2)) - 2*bLp*l0*((-1 + eps)*Power(l0,3) - 3*Power(l0,2)*s + 12*l0*Power(s,2) + 20*Power(s,3)) + (-8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + (l0 + 2*s)*(-8*aR*(l0 + 6*s) + 3*l0*(bL*l0 + bR*l0 - 10*bL*s + 6*bR*s)))*sp)*cos(bL - phiS))/Power(l0,4) + (s*(s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + (-8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) - 16*aLp*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + (l0 + 2*s)*(-8*aR*(l0 + 6*s) - 16*aRp*(l0 + 6*s) + 3*l0*(bL*(l0 - 10*s) + (bR + 2*bRp)*(l0 + 6*s))))*sp + 8*(-8*aR*(l0 + 3*s) + 8*aL*(l0 + 6*s) + 3*l0*(bR*(l0 + 3*s) - bL*(l0 + 5*s)))*Power(sp,2) + bLp*l0*(l0 + 2*s)*(2*Power(l0,2) - l0*(s - 6*sp) - 10*s*(s + 6*sp)))*cos(bL - phiS))/Power(l0,4) + (-2*(1 + eps)*sp + ((2*l0 - 5*s)*Power(l0 + 2*s,2)*sp)/Power(l0,3) - (2*sp*(2*epsp*Power(l0,4) + bL*l0*(bLp - phiSp)*(2*l0 - 5*s)*Power(l0 + 2*s,2) + (bLp - phiSp)*s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) - 3*l0*(l0 - 10*s)*(l0 + 2*s)*sp))/Power(l0,4) + s*(-2*epsp + 2*(1 + eps)*Power(bLp - phiSp,2) - (Power(bLp - phiSp,2)*(2*l0 - 5*s)*Power(l0 + 2*s,2))/Power(l0,3) + ((bLp - phiSp)*(-(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aR - 3*bR*l0)*Power(l0 + 2*s,2) + 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2)))))/Power(l0,4) + (4*(2*l0 - 5*s)*(l0 + 2*s)*sp)/Power(l0,3) - (5*Power(l0 + 2*s,2)*sp)/Power(l0,3) + (8*(2*l0 - 5*s)*Power(sp,2))/Power(l0,3) - (40*(l0 + 2*s)*Power(sp,2))/Power(l0,3) - (2*(bLp - phiSp)*(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2)) - 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + (-8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + (l0 + 2*s)*(-8*aR*(l0 + 6*s) + 3*l0*(bL*l0 + bR*l0 - 10*bL*s + 6*bR*s)))*sp))/Power(l0,4)))*sin(bL - phiS))/2.;
	Jp(5,1) = (-2*epsp*s*cos(bL - phiS) + 2*(1 + eps)*Power(bLp - phiSp,2)*s*cos(bL - phiS) - (Power(bLp - phiSp,2)*(2*l0 - 5*s)*s*Power(l0 + 2*s,2)*cos(bL - phiS))/Power(l0,3) + ((bLp - phiSp)*s*(-(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aR - 3*bR*l0)*Power(l0 + 2*s,2) + 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*cos(bL - phiS))/Power(l0,4) - 2*(1 + eps)*sp*cos(bL - phiS) + (4*(2*l0 - 5*s)*s*(l0 + 2*s)*sp*cos(bL - phiS))/Power(l0,3) + ((2*l0 - 5*s)*Power(l0 + 2*s,2)*sp*cos(bL - phiS))/Power(l0,3) - (5*s*Power(l0 + 2*s,2)*sp*cos(bL - phiS))/Power(l0,3) + (8*(2*l0 - 5*s)*s*Power(sp,2)*cos(bL - phiS))/Power(l0,3) - (40*s*(l0 + 2*s)*Power(sp,2)*cos(bL - phiS))/Power(l0,3) - (2*sp*(2*epsp*Power(l0,4) + bL*l0*(bLp - phiSp)*(2*l0 - 5*s)*Power(l0 + 2*s,2) + (bLp - phiSp)*s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) - 3*l0*(l0 - 10*s)*(l0 + 2*s)*sp)*cos(bL - phiS))/Power(l0,4) + (2*(bLp - phiSp)*s*(-(bLp*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + ((l0 + 2*s)*(l0*(8*aR - 3*(bL + bR)*l0) + 6*(8*aR + 5*bL*l0 - 3*bR*l0)*s) + 8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)))*sp)*cos(bL - phiS))/Power(l0,4) + (((-(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2)) + s*((8*aR - 3*bR*l0)*Power(l0 + 2*s,2) + 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2))))*sp)/Power(l0,4) + (2*sp*(-2*eps*Power(l0,4)*phiSp + s*(Power(l0,2)*(8*aLp + 8*aRp - 3*bRp*l0 + 3*l0*phiSp) - 4*l0*(8*aLp - 8*aRp + 3*l0*(bRp + phiSp))*s - 4*(16*aLp - 8*aRp + 3*bRp*l0 + 5*l0*phiSp)*Power(s,2)) + 2*bLp*l0*((-1 + eps)*Power(l0,3) - 3*Power(l0,2)*s + 12*l0*Power(s,2) + 20*Power(s,3)) + ((l0 + 2*s)*(l0*(8*aR - 3*(bL + bR)*l0) + 6*(8*aR + 5*bL*l0 - 3*bR*l0)*s) + 8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)))*sp))/Power(l0,4) + s*(2*(1 + eps)*(bLp - phiSp) + 4*epsp*(bLp - phiSp) + ((-bLp + phiSp)*(2*l0 - 5*s)*Power(l0 + 2*s,2))/Power(l0,3) + (Power(bLp - phiSp,2)*(bL*l0*(2*l0 - 5*s)*Power(l0 + 2*s,2) + s*(-((8*aR - 3*bR*l0)*Power(l0 + 2*s,2)) - 8*aL*(Power(l0,2) - 4*l0*s - 8*Power(s,2)))))/Power(l0,4) - (8*(bLp - phiSp)*(2*l0 - 5*s)*(l0 + 2*s)*sp)/Power(l0,3) + (10*(bLp - phiSp)*Power(l0 + 2*s,2)*sp)/Power(l0,3) + (s*((8*aRp - 3*bRp*l0)*Power(l0 + 2*s,2) + 8*aLp*(Power(l0,2) - 4*l0*s - 8*Power(s,2))) + (8*aL*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + 16*aLp*(Power(l0,2) - 8*l0*s - 24*Power(s,2)) + (l0 + 2*s)*(8*aR*(l0 + 6*s) + 16*aRp*(l0 + 6*s) - 3*l0*(bL*(l0 - 10*s) + (bR + 2*bRp)*(l0 + 6*s))))*sp + 8*(8*aR*(l0 + 3*s) - 8*aL*(l0 + 6*s) + 3*l0*(-(bR*(l0 + 3*s)) + bL*(l0 + 5*s)))*Power(sp,2) - bLp*l0*(l0 + 2*s)*(2*Power(l0,2) - l0*(s - 6*sp) - 10*s*(s + 6*sp)))/Power(l0,4)))*sin(bL - phiS))/2.;
	Jp(6,0) = (-4*((bLp - phiSp)*s*(l0 + 2*s)*(l0*(s + 4*sp) + 2*s*(s + 8*sp))*cos(bL - phiS) + (-(Power(bLp - phiSp,2)*Power(s,2)*Power(l0 + 2*s,2)) + 2*s*(l0 + 2*s)*(l0 + 4*s)*sp + 2*(Power(l0,2) + 12*l0*s + 24*Power(s,2))*Power(sp,2))*sin(bL - phiS)))/Power(l0,4);
	Jp(6,1) = (4*((Power(bLp - phiSp,2)*Power(s,2)*Power(l0 + 2*s,2) - 2*s*(l0 + 2*s)*(l0 + 4*s)*sp - 2*(Power(l0,2) + 12*l0*s + 24*Power(s,2))*Power(sp,2))*cos(bL - phiS) + (bLp - phiSp)*s*(l0 + 2*s)*(l0*(s + 4*sp) + 2*s*(s + 8*sp))*sin(bL - phiS)))/Power(l0,4);
	Jp(7,0) = (3*((bLp - phiSp)*s*(l0 + 2*s)*(l0*(s + 4*sp) + 2*s*(s + 8*sp))*cos(bL - phiS) + (-(Power(bLp - phiSp,2)*Power(s,2)*Power(l0 + 2*s,2)) + 2*s*(l0 + 2*s)*(l0 + 4*s)*sp + 2*(Power(l0,2) + 12*l0*s + 24*Power(s,2))*Power(sp,2))*sin(bL - phiS)))/(2.*Power(l0,3));
	Jp(7,1) = (-3*((Power(bLp - phiSp,2)*Power(s,2)*Power(l0 + 2*s,2) - 2*s*(l0 + 2*s)*(l0 + 4*s)*sp - 2*(Power(l0,2) + 12*l0*s + 24*Power(s,2))*Power(sp,2))*cos(bL - phiS) + (bLp - phiSp)*s*(l0 + 2*s)*(l0*(s + 4*sp) + 2*s*(s + 8*sp))*sin(bL - phiS)))/(2.*Power(l0,3));
	//JRLp
	Jp(0,2) = 0;
	Jp(1,2) = 0;
	Jp(2,2) = 0;
	Jp(3,2) = 0;
	Jp(4,2) = (8*sp*(-Power(l0,2) + 12*l0*(s + sp) + 48*s*(s + 2*sp)))/Power(l0,4);
	Jp(5,2) = (3*sp*(Power(l0,2) - 12*l0*(s + sp) - 40*s*(s + 2*sp)))/Power(l0,3);
	Jp(6,2) = (-8*sp*(Power(l0,2) + 12*l0*(s + sp) + 24*s*(s + 2*sp)))/Power(l0,4);
	Jp(7,2) = (3*sp*(Power(l0,2) + 12*l0*(s + sp) + 24*s*(s + 2*sp)))/Power(l0,3);
      }
      else
      {
	//JTRp
	...
	Jp(1,0) = 0;
	Jp(1,1) = 0;
	Jp(2,0) = (-2*(1 + eps)*(bRp + phiSp)*s*cos(bR + phiS) - 4*epsp*(bRp + phiSp)*s*cos(bR + phiS) - (Power(bRp + phiSp,2)*s*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS))/Power(l0,4) - 4*(1 + eps)*(bRp + phiSp)*sp*cos(bR + phiS) + ((bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp*cos(bR + phiS))/Power(l0,4) + (2*sp*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp)*cos(bR + phiS))/Power(l0,4) + (s*(s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (Power(l0,2)*(8*(aL + 2*aLp + aR + 2*aRp) - 3*(bL + 2*bLp + bR)*l0) + 8*l0*(-8*aL - 16*aLp + 8*(aR + 2*aRp) + 3*(bL + 2*bLp - bR)*l0)*s + 12*(8*(aL + 2*aLp - 2*aR - 4*aRp) - (3*bL + 6*bLp - 5*bR)*l0)*Power(s,2))*sp + 8*(8*aR*(l0 - 6*s) - 8*aL*(l0 - 3*s) + 3*l0*(bL*l0 - bR*l0 - 3*bL*s + 5*bR*s))*Power(sp,2) + bRp*l0*(l0 - 2*s)*(2*Power(l0,2) + l0*(s - 6*sp) - 10*s*(s + 6*sp)))*cos(bR + phiS))/Power(l0,4) + 2*(-(epsp*s) + (1 + eps)*Power(bRp + phiSp,2)*s - ((bRp + phiSp)*s*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2)))))/(2.*Power(l0,4)) - (1 + eps)*sp - 2*epsp*sp - ((bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp)/Power(l0,4) - ((bRp + phiSp)*s*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp))/Power(l0,4))*sin(bR + phiS))/2.;
	Jp(2,1) = epsp*s*cos(bR + phiS) - (1 + eps)*Power(bRp + phiSp,2)*s*cos(bR + phiS) + ((bRp + phiSp)*s*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS))/(2.*Power(l0,4)) + (1 + eps)*sp*cos(bR + phiS) + 2*epsp*sp*cos(bR + phiS) + ((bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp*cos(bR + phiS))/Power(l0,4) + ((bRp + phiSp)*s*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp)*cos(bR + phiS))/Power(l0,4) + ((-2*(1 + eps)*(bRp + phiSp)*s - 4*epsp*(bRp + phiSp)*s - (Power(bRp + phiSp,2)*s*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2)))))/Power(l0,4) - 4*(1 + eps)*(bRp + phiSp)*sp + ((bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp)/Power(l0,4) + (2*sp*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp))/Power(l0,4) + (s*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (Power(l0,2)*(8*(aL + 2*aLp + aR + 2*aRp) - 3*(bL + 2*bLp + bR + 2*bRp)*l0) + 8*l0*(-8*aL - 16*aLp + 8*(aR + 2*aRp) + 3*(bL + 2*bLp - bR - 2*bRp)*l0)*s + 12*(8*(aL + 2*aLp - 2*aR - 4*aRp) - (3*bL + 6*bLp - 5*(bR + 2*bRp))*l0)*Power(s,2))*sp + 8*(8*aR*(l0 - 6*s) - 8*aL*(l0 - 3*s) + 3*l0*(bL*l0 - bR*l0 - 3*bL*s + 5*bR*s))*Power(sp,2)))/Power(l0,4))*sin(bR + phiS))/2.;
	Jp(3,0) = -((Power(bRp + phiSp,2)*s - sp)*cos(bR + phiS)) - (bRp + phiSp)*(s + 2*sp)*sin(bR + phiS);
	Jp(3,1) = (bRp + phiSp)*(s + 2*sp)*cos(bR + phiS) - (Power(bRp + phiSp,2)*s - sp)*sin(bR + phiS);
	Jp(4,0) = (-4*(-((bRp + phiSp)*(l0 - 2*s)*s*(l0*(s + 4*sp) - 2*s*(s + 8*sp))*cos(bR + phiS)) + (Power(bRp + phiSp,2)*Power(l0 - 2*s,2)*Power(s,2) - 2*(l0 - 4*s)*(l0 - 2*s)*s*sp - 2*(Power(l0,2) - 12*l0*s + 24*Power(s,2))*Power(sp,2))*sin(bR + phiS)))/Power(l0,4);
	Jp(4,1) = (4*((Power(bRp + phiSp,2)*Power(l0 - 2*s,2)*Power(s,2) - 2*(l0 - 4*s)*(l0 - 2*s)*s*sp - 2*(Power(l0,2) - 12*l0*s + 24*Power(s,2))*Power(sp,2))*cos(bR + phiS) + (bRp + phiSp)*(l0 - 2*s)*s*(l0*(s + 4*sp) - 2*s*(s + 8*sp))*sin(bR + phiS)))/Power(l0,4);
	Jp(5,0) = (3*(-((bRp + phiSp)*(l0 - 2*s)*s*(l0*(s + 4*sp) - 2*s*(s + 8*sp))*cos(bR + phiS)) + (Power(bRp + phiSp,2)*Power(l0 - 2*s,2)*Power(s,2) - 2*(l0 - 4*s)*(l0 - 2*s)*s*sp - 2*(Power(l0,2) - 12*l0*s + 24*Power(s,2))*Power(sp,2))*sin(bR + phiS)))/(2.*Power(l0,3));
	Jp(5,1) = (-3*((Power(bRp + phiSp,2)*Power(l0 - 2*s,2)*Power(s,2) - 2*(l0 - 4*s)*(l0 - 2*s)*s*sp - 2*(Power(l0,2) - 12*l0*s + 24*Power(s,2))*Power(sp,2))*cos(bR + phiS) + (bRp + phiSp)*(l0 - 2*s)*s*(l0*(s + 4*sp) - 2*s*(s + 8*sp))*sin(bR + phiS)))/(2.*Power(l0,3));
	Jp(6,0) = (-4*(-((bRp + phiSp)*s*(Power(l0,2)*(s + 4*sp) + 4*l0*s*(s + 6*sp) - 8*Power(s,2)*(s + 8*sp))*cos(bR + phiS)) + (Power(bRp + phiSp,2)*Power(s,2)*(Power(l0,2) + 4*l0*s - 8*Power(s,2)) - 2*(l0 - 2*s)*s*(l0 + 8*s)*sp - 2*(Power(l0,2) + 12*l0*s - 48*Power(s,2))*Power(sp,2))*sin(bR + phiS)))/Power(l0,4);
	Jp(6,1) = (4*((Power(bRp + phiSp,2)*Power(s,2)*(Power(l0,2) + 4*l0*s - 8*Power(s,2)) - 2*(l0 - 2*s)*s*(l0 + 8*s)*sp - 2*(Power(l0,2) + 12*l0*s - 48*Power(s,2))*Power(sp,2))*cos(bR + phiS) + (bRp + phiSp)*s*(Power(l0,2)*(s + 4*sp) + 4*l0*s*(s + 6*sp) - 8*Power(s,2)*(s + 8*sp))*sin(bR + phiS)))/Power(l0,4);
	Jp(7,0) = (-(l0*(bRp + phiSp)*s*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*cos(bR + phiS)) - Power(bRp + phiSp,2)*s*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS) - 2*l0*(bRp + phiSp)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*sp*cos(bR + phiS) + (bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp*cos(bR + phiS) - 2*l0*(bRp + phiSp)*s*(2*epsp*Power(l0,3) + 3*(l0 - 2*s)*(l0 + 10*s)*sp)*cos(bR + phiS) + 2*sp*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp)*cos(bR + phiS) + s*(s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (Power(l0,2)*(8*(aL + 2*aLp + aR + 2*aRp) - 3*(bL + 2*bLp + bR)*l0) + 8*l0*(-8*aL - 16*aLp + 8*(aR + 2*aRp) + 3*(bL + 2*bLp - bR)*l0)*s + 12*(8*(aL + 2*aLp - 2*aR - 4*aRp) - (3*bL + 6*bLp - 5*bR)*l0)*Power(s,2))*sp + 8*(8*aR*(l0 - 6*s) - 8*aL*(l0 - 3*s) + 3*l0*(bL*l0 - bR*l0 - 3*bL*s + 5*bR*s))*Power(sp,2) + bRp*l0*(l0 - 2*s)*(2*Power(l0,2) + l0*(s - 6*sp) - 10*s*(s + 6*sp)))*cos(bR + phiS) + (-(l0*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*sp) - 2*(bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp - 2*l0*sp*(2*epsp*Power(l0,3) + 3*(l0 - 2*s)*(l0 + 10*s)*sp) + s*(l0*Power(bRp + phiSp,2)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2))) + (-bRp - phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2)))) - 2*(bRp + phiSp)*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp) - l0*(2*epsp*Power(l0,3) + 3*sp*(Power(l0,2) + 8*l0*(s + sp) - 20*s*(s + 2*sp)))))*sin(bR + phiS))/(2.*Power(l0,4));
	Jp(7,1) = (-(l0*Power(bRp + phiSp,2)*s*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*cos(bR + phiS)) + (bRp + phiSp)*s*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*cos(bR + phiS) + l0*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*sp*cos(bR + phiS) + 2*(bRp + phiSp)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp*cos(bR + phiS) + 2*l0*sp*(2*epsp*Power(l0,3) + 3*(l0 - 2*s)*(l0 + 10*s)*sp)*cos(bR + phiS) + 2*(bRp + phiSp)*s*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp)*cos(bR + phiS) + l0*s*(2*epsp*Power(l0,3) + 3*sp*(Power(l0,2) + 8*l0*(s + sp) - 20*s*(s + 2*sp)))*cos(bR + phiS) + (-2*l0*(bRp + phiSp)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))*sp + (bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2))))*sp + 2*sp*(bRp*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) + (8*aL*(l0 - 6*s)*(l0 - 2*s) - 3*l0*(l0 - 2*s)*(bL*l0 + bR*l0 - 6*bL*s + 10*bR*s) + 8*aR*(Power(l0,2) + 8*l0*s - 24*Power(s,2)))*sp) + s*(-(l0*(bRp + phiSp)*(2*eps*Power(l0,3) + s*(3*Power(l0,2) + 12*l0*s - 20*Power(s,2)))) + s*(8*aLp*Power(l0 - 2*s,2) - 3*bLp*l0*Power(l0 - 2*s,2) + 8*aRp*(Power(l0,2) + 4*l0*s - 8*Power(s,2))) - Power(bRp + phiSp,2)*(bR*l0*Power(l0 - 2*s,2)*(2*l0 + 5*s) + s*(8*aL*Power(l0 - 2*s,2) - 3*bL*l0*Power(l0 - 2*s,2) + 8*aR*(Power(l0,2) + 4*l0*s - 8*Power(s,2)))) + (Power(l0,2)*(8*(aL + 2*aLp + aR + 2*aRp) - 3*(bL + 2*bLp + bR)*l0) + 8*l0*(-8*aL - 16*aLp + 8*(aR + 2*aRp) + 3*(bL + 2*bLp - bR)*l0)*s + 12*(8*(aL + 2*aLp - 2*aR - 4*aRp) - (3*bL + 6*bLp - 5*bR)*l0)*Power(s,2))*sp + 8*(8*aR*(l0 - 6*s) - 8*aL*(l0 - 3*s) + 3*l0*(bL*l0 - bR*l0 - 3*bL*s + 5*bR*s))*Power(sp,2) - 2*l0*(bRp + phiSp)*(2*epsp*Power(l0,3) + 3*(l0 - 2*s)*(l0 + 10*s)*sp) + bRp*l0*(l0 - 2*s)*(2*Power(l0,2) + l0*(s - 6*sp) - 10*s*(s + 6*sp))))*sin(bR + phiS))/(2.*Power(l0,4));
	//JRRp
	Jp(0,2) = 0;
	Jp(1,2) = 0;
	Jp(2,2) = 0;
	Jp(3,2) = 0;
	Jp(4,2) = (-8*sp*(Power(l0,2) - 12*l0*(s + sp) + 24*s*(s + 2*sp)))/Power(l0,4);
	Jp(5,2) = (3*sp*(Power(l0,2) - 12*l0*(s + sp) + 24*s*(s + 2*sp)))/Power(l0,3);
	Jp(6,2) = (-8*sp*(Power(l0,2) + 12*l0*(s + sp) - 48*s*(s + 2*sp)))/Power(l0,4);
	Jp(7,2) = (3*sp*(Power(l0,2) + 12*l0*(s + sp) - 40*s*(s + 2*sp)))/Power(l0,3);
      }
    }
