...
namespace MBSimFlexibleBody {
  ...
  class FlexibleBody : public NodeBasedBody {
    public:
      ...
      virtual void setq0(const fmatvec::Vec &q0_) { if(q0_.size()) MBSim::Body::setGeneralizedInitialPosition(q0_); q <<= q0; }
      virtual void setu0(const fmatvec::Vec &u0_) { if(u0_.size()) MBSim::Body::setGeneralizedInitialVelocity(u0_); u <<= u0; }
      /***************************************************/
