...
namespace MBSimFlexibleBody {
  ...
  class ContactKinematicsPointFlexibleBand : public MBSim::ContactKinematics {
    public:
      ...
      virtual void updatewb(double t, fmatvec::Vec& wb, double g, MBSim::ContourPointData *cpData) { throw MBSim::MBSimError("(ContactKinematicsPointFlexibleBand::updatewb): not implemented!"); }
      /***************************************************/
