...
namespace MBSimFlexibleBody {
  ...
  class ContactKinematicsCircleHollowCylinderFlexible : public MBSim::ContactKinematics {
    public:
      ...
      virtual void updatewb(fmatvec::Vec &wb, double g, MBSim::ContourPointData* cpData) { throw MBSim::MBSimError("(ContactKinematicsCircleHollowCylinderFlexible::updatewb): Not implemented!"); };
      /***************************************************/
