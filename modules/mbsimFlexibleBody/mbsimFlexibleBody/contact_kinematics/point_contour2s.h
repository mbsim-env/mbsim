...
//  class FlexibleBodyLinearExternalFFR;
  ...
  class ContactKinematicsPointContour2s : public MBSim::ContactKinematics {
    public:
      ...
      virtual void updatewb(fmatvec::Vec &wb, double g, MBSim::ContourPointData* cpData) { throw MBSim::MBSimError("(ContactKinematicsPointContour2s::updatewb): Not implemented!"); };
      /***************************************************/
