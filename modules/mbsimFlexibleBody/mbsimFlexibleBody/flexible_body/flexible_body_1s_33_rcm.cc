...
namespace MBSimFlexibleBody {
  ...
  MBSIM_OBJECTFACTORY_REGISTERXMLNAME(FlexibleBody, FlexibleBody1s33RCM, MBSIMFLEX%"FlexibleBody1s33RCMCantilever")
  MBSIM_OBJECTFACTORY_REGISTERXMLNAME(FlexibleBody, FlexibleBody1s33RCM, MBSIMFLEX%"FlexibleBody1s33RCMRing")
