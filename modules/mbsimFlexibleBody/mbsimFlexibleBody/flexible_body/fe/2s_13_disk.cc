...
#include <config.h>
#include <fstream>
#include "mbsimFlexibleBody/flexible_body/fe/2s_13_disk.h"
...
namespace MBSimFlexibleBody {
  ...
  FiniteElement2s13Disk::FiniteElement2s13Disk(double E_, double nu_, double rho_) :  E(E_),nu(nu_), G(E/(2.*(1.+nu))), rho(rho_), alphaS(5./6.), RefDofs(2), NodeDofs(3), Nodes(4), M(14,INIT,0.), K(14,INIT,0.) { }
