...
namespace MBSimFlexibleBody {
  ...
  void GenericFlexibleFfrBody::assemble() {
	...
	throwError(string("(GenericFlexibleFfrBody::init): size of modal damping does not match, must be ") +
	    to_string(Pdm.cols()) + ", but is " + to_string(mDamping.size()) + ".");
