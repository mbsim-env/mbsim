 ...
 void GenericFlexibleFfrBody::updatePositions() {
  ...
  void GenericFlexibleFfrBody::updateGyroscopicAccelerations() {
    ...
    if(fAPK and not(constJR and constjR))
      PjbR = (fAPK->parDer1DirDer1(evalqdRRel(),evalqRRel(),getTime())+fAPK->parDer1DirDer2(1,evalqRRel(),getTime()))*getuRRel() + fAPK->parDer2DirDer1(evalqdRRel(),evalqRRel(),getTime());
    updPjb = false;
  }
