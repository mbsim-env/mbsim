...
namespace MBSimPhysics {
  ...
  class Drag : public MBSim::FloatingFrameLink {
    public:
      Drag(const std::string &name="");
      ~Drag() override;
      ...
      void setDragFunction(MBSim::Function<double(double)> *func);
    ...
    protected:
      MBSim::Function<double(double)> *fdrag{nullptr};
