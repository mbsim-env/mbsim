...
namespace MBSimFlexibleBody {
  ...
  class Weight33RCM {
    public:
      ...
      fmatvec::Mat4x16 getwh1coefqIH() const;
      fmatvec::Mat4x16 getwh2coefqIH() const;
  ...
  inline fmatvec::Mat4x16 Weight33RCM::getwh1coefqIH() const { return wh1coefqI.T(); }
  inline fmatvec::Mat4x16 Weight33RCM::getwh2coefqIH() const { return wh2coefqI.T(); }
