...
namespace MBSimFlexibleBody {
  ...
  PositionFunction::PositionFunction(RevCardanPtr angle_, double l0_, const Vec3& pL_, const Vec3& pR_, double cL1_, double cR1_, double cL2_, double cR2_, const fmatvec::RowVec3& rRrLmH_) :
  ...
  SqrMat11 PositionJacobian::operator()(const Vec11& pos, const void *) {
    Vec3 pS = pos(0, 2);
  ...
  Trafo33RCM::Trafo33RCM(RevCardanPtr angle_, double l0_) :
    ...
    SMRHS_Jac(4, 10) = 1.;
    SMRHS_Jac(4, 9) = -1.;
    SMRHS_Jac.set(Index(7, 7), Index(3, 6), 2. * xstarh2 * (V(Index(1, 1), Index(0, 3)) * xstarh2 + V(Index(3, 3), Index(3, 3))));
  ...
  void Trafo33RCM::computeJIGt(const Vec16& qGt) {
    ...
    JIGt.set(Index(7, 17), Index(0, 15), beqGt(Index(3, 10), Index(0, 15)));
    ...
    JIGt(Index(15, 15), Index(0, 15)) /= l0;
  }
