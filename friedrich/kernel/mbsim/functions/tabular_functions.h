...
namespace MBSim {
  ...
  class TwoDimensionalTabularFunction : public fmatvec::Function<Ret(double,double)> {
    public:
      TwoDimensionalTabularFunction() : xSize(0), ySize(0), x0Index(0), x1Index(0), y0Index(0), y1Index(0), func_value(1,fmatvec::INIT,0), xy(4,fmatvec::INIT,1), XYval(4,fmatvec::INIT,0), XYfac(4,4,fmatvec::INIT,0) { }
