...
ret=subprocess.call([SCRIPTDIR+"/distribute.py", "/home/mbsim/linux64-dailyrelease/local", "--distFile",
                    OUTDIR+"/download/mbsim-env-linux64-shared-build-xxx"], stderr=subprocess.STDOUT, stdout=f)
