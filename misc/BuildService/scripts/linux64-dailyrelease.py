...
if subprocess.call([SCRIPTDIR+"/linux64-dailyrelease-distribute.sh"], stderr=subprocess.STDOUT, stdout=f)!=0:
  ...
  addBuildSystemFeed.add("Linux64 Daily Release distribution", "Linux64 Daily Release: creating distribution failed",
                         "See the linked web page for details", URL+"/report_distribute/distribute.out")
f.close()
