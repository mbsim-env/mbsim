...
namespace MBSimFlexibleBody {
  ...
  class NeutralNurbsVelocity1s : public MBSimFlexibleBody::NeutralNurbs1s {
    public:
      NeutralNurbsVelocity1s(Element* parent_, std::vector<ContourPointData>& ContourPoints_, double nodeOffset, double uMin_, double uMax_, int degU_, bool openStructure_);
