...
namespace MBSimFlexibleBody {
  ...
  class NeutralNurbsVelocity2s : public MBSimFlexibleBody::NeutralNurbs2s {
    public:
      NeutralNurbsVelocity2s(Element* parent_, fmatvec::GeneralMatrix<ContourPointData>& ContourPoints_, double nodeOffset, int degU_, int degV_, bool openStructure_);
