...
- A new link "generalized initial condition" is now available. This new link allows to define the generalized initial position and velocity of an object by constraints.
