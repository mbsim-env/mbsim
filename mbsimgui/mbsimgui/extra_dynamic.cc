...
ExtraDynamic::ExtraDynamic(const string &str, Element *parent) : Element(str, parent) {
}

ExtraDynamic::~ExtraDynamic() {
}

ExtraDynamic* ExtraDynamic::readXMLFile(const string &filename, Element *parent) {
  TiXmlDocument doc;
...
//TiXmlElement* ExtraDynamic::writeXMLFile(TiXmlNode *parent) {    
//}
