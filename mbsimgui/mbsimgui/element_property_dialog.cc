...
namespace MBSimGUI {
  ...
  CylindricalGearPropertyDialog::CylindricalGearPropertyDialog(Element *disk) : RigidContourPropertyDialog(disk) {
    addTab("Visualization",1);
  ...
  RackPropertyDialog::RackPropertyDialog(Element *disk) : RigidContourPropertyDialog(disk) {
    addTab("Visualization",1);
