...
namespace MBSimGUI {
  ...
  class C3D20 : public FiniteElementType {
    public:
      C3D20();
    ...
    private:
      fmatvec::Vec3 rN[20], rI[27];
      double wI[27];
      int indices[6][4];
      double (C3D20::*N_[20])(double x, double y, double z) const;
      double (C3D20::*dNdq_[20][3])(double x, double y, double z) const;
