...
namespace MBSimGUI {
  ...
  MBSimEnvironmentWidget::MBSimEnvironmentWidget() {
    ...
    openMBVObject = new ExtWidget("OpenMBV objects",new ListWidget(new ChoiceWidgetFactory(new OMBVRigidBodyWidgetFactory,1),"OpenMBV object",0,0,false),false,false,MBSIM%"openMBVObject");
