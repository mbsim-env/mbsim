...
System::System(const string &projectName) : DynamicSystemSolver(projectName) {
  ...
  /* disk */
  // body
  //FlexibleBodyCylindricalDisk *disk = new FlexibleBodyCylindricalDisk("Disk");
  FlexibleBody2s13Disk *disk = new FlexibleBody2s13Disk("Disk");
  double E = 2.1e11; // Young's modulus  
  double rho = 7.7e3; // density
  double nu = 0.3; // poisson ratio
  double rI = 2.25e-3; // inner radius
  double rO = 7.7e-1; // outer radius
  Vec d(3); d(0) = 2.e-2; // thickness at r==0 
  ...
  int nr = 5; // radial number of elements
  int nj = 5; // azimuthal number of elements
