...
//    MBSimEnvironment::getInstance()->setAccelerationOfGravity(grav);
    ...
    OpenMBV::PolygonPoint *corner1 = new OpenMBV::PolygonPoint(b0 * 0.5, w0 * 0.5, 1);
    rectangle->push_back(corner1);
    OpenMBV::PolygonPoint *corner2 = new OpenMBV::PolygonPoint(b0 * 0.5, -w0 * 0.5, 1);
    rectangle->push_back(corner2);
    OpenMBV::PolygonPoint *corner3 = new OpenMBV::PolygonPoint(-b0 * 0.5, -w0 * 0.5, 1);
    rectangle->push_back(corner3);
    OpenMBV::PolygonPoint *corner4 = new OpenMBV::PolygonPoint(-b0 * 0.5, w0 * 0.5, 1);
