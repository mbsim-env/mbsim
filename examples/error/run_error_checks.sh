...
grep "^hierachical_modelling/ppError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA5
...
grep "^hierachical_modelling/parseError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA11
...
grep "^hierachical_modelling/initXMLError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA16
...
grep "^hierachical_modelling/mbsimError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA21
...
grep "^hierachical_modelling_inlineembed1/ppError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA25
...
grep "^hierachical_modelling_inlineembed1/parseError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA30
...
grep "^hierachical_modelling_inlineembed1/initXMLError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA34
...
grep "^hierachical_modelling_inlineembed1/mbsimError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA38
...
grep "^hierachical_modelling_inlineembed2/ppError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA42
...
grep "^hierachical_modelling_inlineembed2/parseError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA47
...
grep "^hierachical_modelling_inlineembed2/initXMLError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA51
...
grep "^hierachical_modelling_inlineembed2/mbsimError/MBS.mbsx:8: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA55
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling/ppError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB5
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling/parseError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB11
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling/initXMLError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB16
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling/mbsimError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB21
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed1/ppError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB25
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed1/parseError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB30
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed1/initXMLError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB34
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed1/mbsimError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB38
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed2/ppError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB42
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed2/parseError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB47
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed2/initXMLError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB51
...
grep "xpath=/${NS}Embed\[1]/${NS}MBSimProject\[1]/${NS}Embed\[1][\"&].*>.*hierachical_modelling_inlineembed2/mbsimError/MBS.mbsx<.*>included from here" $OUTFILE > /dev/null || echo ERRORB55
