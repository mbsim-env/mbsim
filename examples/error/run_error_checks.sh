...
grep -E "^hierachical_modelling/ppError/submodel/Untergruppe.xml:11:" $OUTFILE > /dev/null || echo ERRORA2
grep -E "^hierachical_modelling/ppError/Hauptgruppe.xml:$LINEE3: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA3
grep -E "^hierachical_modelling/ppError/MBS.mbsim.xml:$LINEE2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA4
grep -E "^hierachical_modelling/ppError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA5

mbsimxml hierachical_modelling/parseError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA6
grep -E "^hierachical_modelling/parseError/submodel/Untergruppe.xml:15:" $OUTFILE > /dev/null || echo ERRORA7
grep -E "^hierachical_modelling/parseError/Hauptgruppe.xml:$LINEE3:" $OUTFILE > /dev/null || echo ERRORA9
grep -E "^hierachical_modelling/parseError/MBS.mbsim.xml:$LINEE2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA10
grep -E "^hierachical_modelling/parseError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA11

mbsimxml hierachical_modelling/initXMLError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA12
grep -E "^hierachical_modelling/initXMLError/submodel/Untergruppe.xml:16:" $OUTFILE > /dev/null || echo ERRORA13
grep -E "^hierachical_modelling/initXMLError/Hauptgruppe.xml:$LINEE3: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA14
grep -E "^hierachical_modelling/initXMLError/MBS.mbsim.xml:$LINEE2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA15
grep -E "^hierachical_modelling/initXMLError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA16

mbsimxml hierachical_modelling/mbsimError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA17
grep -E "^hierachical_modelling/mbsimError/submodel/Untergruppe.xml:10:" $OUTFILE > /dev/null || echo ERRORA18
grep -E "^hierachical_modelling/mbsimError/Hauptgruppe.xml:$LINEE3: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA19
grep -E "^hierachical_modelling/mbsimError/MBS.mbsim.xml:$LINEE2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA20
grep -E "^hierachical_modelling/mbsimError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA21

mbsimxml hierachical_modelling_inlineembed1/ppError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA22
grep -E "^hierachical_modelling_inlineembed1/ppError/Hauptgruppe.xml:48:" $OUTFILE > /dev/null || echo ERRORA23
grep -E "^hierachical_modelling_inlineembed1/ppError/MBS.mbsim.xml:$LINEE2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA24
grep -E "^hierachical_modelling_inlineembed1/ppError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA25

mbsimxml hierachical_modelling_inlineembed1/parseError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA26
grep -E "^hierachical_modelling_inlineembed1/parseError/Hauptgruppe.xml:52:" $OUTFILE > /dev/null || echo ERRORA27
grep -E "^hierachical_modelling_inlineembed1/parseError/MBS.mbsim.xml:$LINEE2:" $OUTFILE > /dev/null || echo ERRORA29
grep -E "^hierachical_modelling_inlineembed1/parseError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA30

mbsimxml hierachical_modelling_inlineembed1/initXMLError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA31
grep -E "^hierachical_modelling_inlineembed1/initXMLError/Hauptgruppe.xml:53:" $OUTFILE > /dev/null || echo ERRORA32
grep -E "^hierachical_modelling_inlineembed1/initXMLError/MBS.mbsim.xml:$LINEE2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA33
grep -E "^hierachical_modelling_inlineembed1/initXMLError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA34

mbsimxml hierachical_modelling_inlineembed1/mbsimError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA35
grep -E "^hierachical_modelling_inlineembed1/mbsimError/Hauptgruppe.xml:47:" $OUTFILE > /dev/null || echo ERRORA36
grep -E "^hierachical_modelling_inlineembed1/mbsimError/MBS.mbsim.xml:$LINEE2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA37
grep -E "^hierachical_modelling_inlineembed1/mbsimError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA38

mbsimxml hierachical_modelling_inlineembed2/ppError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA39
grep -E "^hierachical_modelling_inlineembed2/ppError/submodel/Untergruppe.xml:11:" $OUTFILE > /dev/null || echo ERRORA40
grep -E "^hierachical_modelling_inlineembed2/ppError/MBS.mbsim.xml:$LINEI2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA41
grep -E "^hierachical_modelling_inlineembed2/ppError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA42

mbsimxml hierachical_modelling_inlineembed2/parseError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA43
grep -E "^hierachical_modelling_inlineembed2/parseError/submodel/Untergruppe.xml:15:" $OUTFILE > /dev/null || echo ERRORA44
grep -E "^hierachical_modelling_inlineembed2/parseError/MBS.mbsim.xml:$LINEI2:" $OUTFILE > /dev/null || echo ERRORA46
grep -E "^hierachical_modelling_inlineembed2/parseError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA47

mbsimxml hierachical_modelling_inlineembed2/initXMLError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA48
grep -E "^hierachical_modelling_inlineembed2/initXMLError/submodel/Untergruppe.xml:16:" $OUTFILE > /dev/null || echo ERRORA49
grep -E "^hierachical_modelling_inlineembed2/initXMLError/MBS.mbsim.xml:$LINEI2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA50
grep -E "^hierachical_modelling_inlineembed2/initXMLError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA51

mbsimxml hierachical_modelling_inlineembed2/mbsimError/MBS.mbsx &> $OUTFILE
test $? -eq 0 && echo ERRORA52
grep -E "^hierachical_modelling_inlineembed2/mbsimError/submodel/Untergruppe.xml:10:" $OUTFILE > /dev/null || echo ERRORA52
grep -E "^hierachical_modelling_inlineembed2/mbsimError/MBS.mbsim.xml:$LINEI2: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA54
grep -E "^hierachical_modelling_inlineembed2/mbsimError/MBS.mbsx:$LINEE1+: \[ecount=1] included from here" $OUTFILE > /dev/null || echo ERRORA55
...
grep -E ".*xpath=/${NS}Group\[1]/${NS}objects\[1]/${NS}RigidBody\[1]/${NS}frameForKinematics\[1][\"&].*>.*hierachical_modelling/parseError/submodel/Untergruppe.xml<" $OUTFILE > /dev/null || echo ERRORB8
...
grep -E ".*xpath=/${NS}Group\[1]/${NS}groups\[1]/${NS}Embed\[2]/${NS}Group\[1]/${NS}objects\[1]/${NS}RigidBody\[1]/${NS}frameForKinematics\[1][\"&].*>.*hierachical_modelling_inlineembed1/parseError/Hauptgruppe.xml<" $OUTFILE > /dev/null || echo ERRORB28
...
grep -E ".*xpath=/${NS}Group\[1]/${NS}objects\[1]/${NS}RigidBody\[1]/${NS}frameForKinematics\[1][\"&].*>.*hierachical_modelling_inlineembed2/parseError/submodel/Untergruppe.xml<" $OUTFILE > /dev/null || echo ERRORB45
